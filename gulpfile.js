...
exports.develop = series(deleteDist, parallel('css', 'javascript', 'html', 'imgcompress', 'imageWebp', 'svgSprites', 'fonts'))
exports.start = series(parallel('css', 'javascript', 'html'))
exports.build = series(deleteDist, parallel('css', 'javascript', 'html', 'imgcompress', 'imageWebp', 'svgSprites', 'fonts'))
